...
// NewWaypointClient creates a new instance of WaypointClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewWaypointClient(t testing.TB) *WaypointClient {
	mock := &WaypointClient{}
	mock.Mock.Test(t)
